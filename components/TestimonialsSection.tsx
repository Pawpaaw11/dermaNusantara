              ...
              <div className="flex flex-1 flex-col p-5 md:p-7">
                <div className="mb-5 flex items-center justify-between gap-4 md:mb-7">
                  {testimonial.photoUrl ? (
                    <img className="size-12 rounded-full border-[3px] border-slate-300 bg-slate-100 object-cover md:size-16 md:border-4" src={testimonial.photoUrl} alt={`Foto ${testimonial.name}`} />
                  ) : (
